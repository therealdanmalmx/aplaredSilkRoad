  ...
  return (
    <AlertDialog>
        ...
        <AlertDialogContent>
            ...
            <AlertDialogAction variant="destructive" className="cursor-pointer text-background bg-destructive hover:text-destructive hover:bg-mu/50 hover:border-destructive">Delete</AlertDialogAction>
            </AlertDialogFooter>
        </AlertDialogContent>
        </AlertDialog>  )
}
