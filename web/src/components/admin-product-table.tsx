...
export function AdminProductTable({
  ...
  return (
    <Table className='w-full mx-auto'>
      <TableHeader>
        <TableRow>
          <TableHead className='text-xl text-primary font-bold'>
            Product
          </TableHead>
          ...
          <TableHead className='text-xl text-primary font-bold text-right'>
            Actions
          </TableHead>
        </TableRow>
      </TableHeader>
        ...
        {products
          ...
          .map((product: Product) => (
            <TableRow key={product.id}>
              ...
              <TableCell className='w-125 text-wrap whitespace-normal'>
                {product.description}
              </TableCell>
